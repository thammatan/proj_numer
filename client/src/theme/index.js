module.exports = {
  ...
  '@layout-body-background': '#f1f3ce',
  '@layout-header-background': '#00293c',
  '@layout-trigger-background': '#011a27',
  '@font-size-base': '12px',
  ...
  '@progress-radius': '0',
  '@menu-dark-submenu-bg': '#1e1f26',
  '@menu-dark-highlight-color': '#e6df44',
